...
class Delegate extends BLE.BleDelegate {
    ...
    function onConnectedStateChanged(device, state) {
        if (state == BLE.CONNECTION_STATE_CONNECTED) {
            ...
            WatchUi.switchToView(new Connecting(), new SensoryBehaviorDelegate(new BLEScanner(), null, false), WatchUi.SLIDE_IMMEDIATE);
            System.println("View switched.");
        } else {
            self.device = null;
            WatchUi.switchToView(new SensorDisconnected(), new SensoryBehaviorDelegate(new BLEScanner(), null, false), WatchUi.SLIDE_IMMEDIATE);
        }
    }
...
class BLEScanner extends WatchUi.View {
    ...
    function scanEnd() {
        ...
        if (result == null) {
            WatchUi.switchToView(new SensorNotFound(), new SensoryBehaviorDelegate(new BLEScanner(), null, false), WatchUi.SLIDE_IMMEDIATE);
        } else {
